...
namespace EliteAPI.Plugins
{
    public class VoiceAttackPlugin
    {
        ...
        private static void SubscribeToEvents()
        {
            ...
            Api.Events.BountyEvent += (sender, e) => e.Rewards.
            ...
            Api.Ship.AltitudeFromAverageRadius.OnChange += (sender, e) => SetShipVariable("AltitudeFromAverageRadius", e);
        ...
        private static string ToEventCommand(IEvent e)
        {
            return ToEventCommand(e.Event);
        }

        private static string ToEventCommand(string command)
        {
            return $"((EliteAPI.{command}))";
        }

        private static string ToEventVariable(string variable)
        {
            return $"EliteAPI.{variable}";
        }

        private static string ToShipCommand(string command)
        {
            return $"((EliteApi.Ship.{command}))";
        }

        private static string ToShipVariable(string variable)
        {
            return $"EliteAPI.{variable}";
        }
        ...
        private static bool HasBeenSubscribedTo(IEvent e)
        {
            return HasBeenSubscribedTo(ToEventCommand(e));
        }
        ...
        private static void SetVariables(IEvent e)
        {
